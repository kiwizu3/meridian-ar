...
export default function ZeroHungerPart1() {
  return (
    <div>
      <div className="bg-[#5d8de8] text-black p-8">
        <div className="w-full">
            ...
            <div className="grid grid-cols-1 gap-6">
              <div>
                ...
                <p className="mt-4">
                  ...
                  platforms: one for individual customers and another tailored
                  for merchants, enabling secure and efficient digital
                  transactions for a range of financial needs.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#7ba1eb] rounded-lg p-6 mb-8">
            <div className="flex items-center mb-4">
              <h2 className="text-2xl font-semibold">
                STRENGTHENING THE ECONOMY THROUGH RESPONSIBLE CONTRIBUTIONS
              </h2>
            </div>
            <div className="grid grid-cols-1 gap-6">
              <div>
