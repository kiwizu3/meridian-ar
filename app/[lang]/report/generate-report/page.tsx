      ...
      <div className="max-w-5xl mx-auto bg-[#17634F] rounded-lg shadow-lg p-6 md:p-10">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8 bg-[#138466] rounded-lg p-6 mb-8">
          <div className="flex-shrink-0 flex items-center justify-center">
            <img src="/images/report/logo.png" alt="LB Finance Logo" className="w-16 h-16 object-contain" />
          </div>
          <div className="flex-1">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Generate Your Own Report</h2>
            <p className="text-white text-sm md:text-base max-w-xl">
              Create customized reports based on your data. Choose the metrics, time range, and format you need—then generate a report instantly for easy analysis and sharing.
            </p>
          </div>
        </div>
        {/* Grid Section */}
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            {/* Row 1 - Left Column */}
            <div>
              <h3 className="font-bold text-white mb-4">1. Report Navigation</h3>
              <div className="flex flex-col gap-2 text-white text-sm">
                <label htmlFor="nav-oath" className="flex items-center cursor-pointer">
                  <input 
                    id="nav-oath" 
                    type="checkbox" 
                ...
                <label htmlFor="nav-vision" className="flex items-center cursor-pointer">
                  <input 
                    id="nav-vision" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="nav-innovate" className="flex items-center cursor-pointer">
                  <input 
                    id="nav-innovate" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="nav-carbon" className="flex items-center cursor-pointer">
                  <input 
                    id="nav-carbon" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="nav-guide" className="flex items-center cursor-pointer">
                  <input 
                    id="nav-guide" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="nav-intro" className="flex items-center cursor-pointer">
                  <input 
                    id="nav-intro" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="nav-about" className="flex items-center cursor-pointer">
                  <input 
                    id="nav-about" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
            ...
            <div>
              ...
              <div className="flex flex-col gap-2 text-white text-sm">
                <label htmlFor="co-lbf" className="flex items-center cursor-pointer">
                  <input 
                    id="co-lbf" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="co-socio" className="flex items-center cursor-pointer">
                  <input 
                    id="co-socio" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="co-awards" className="flex items-center cursor-pointer">
                  <input 
                    id="co-awards" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="co-finhi" className="flex items-center cursor-pointer">
                  <input 
                    id="co-finhi" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="co-nonfin" className="flex items-center cursor-pointer">
                  <input 
                    id="co-nonfin" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="co-strat" className="flex items-center cursor-pointer">
                  <input 
                    id="co-strat" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="co-snap" className="flex items-center cursor-pointer">
                  <input 
                    id="co-snap" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
            ...
            {/* Row 2 - Left Column */}
            <div>
              <h3 className="font-bold text-white mb-4">3. Management Discussion and Analysis</h3>
              <div className="flex flex-col gap-2 text-white text-sm">
                <label htmlFor="mda-chair" className="flex items-center cursor-pointer">
                  <input 
                    id="mda-chair" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda-md" className="flex items-center cursor-pointer">
                  <input 
                    id="mda-md" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda-bmvc" className="flex items-center cursor-pointer">
                  <input 
                    id="mda-bmvc" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda-oe" className="flex items-center cursor-pointer">
                  <input 
                    id="mda-oe" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda-ise" className="flex items-center cursor-pointer">
                  <input 
                    id="mda-ise" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda-mat" className="flex items-center cursor-pointer">
                  <input 
                    id="mda-mat" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda-ltss" className="flex items-center cursor-pointer">
                  <input 
                    id="mda-ltss" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda-b25" className="flex items-center cursor-pointer">
                  <input 
                    id="mda-b25" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
            ...
            {/* Row 2 - Right Column */}
            <div>
              <h3 className="font-bold text-white mb-4">4. Management Discussion and Analysis</h3>
              <div className="flex flex-col gap-2 text-white text-sm">
                <label htmlFor="mda2-web" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-web" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-lead" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-lead" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-gov" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-gov" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-pledge" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-pledge" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-ops" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-ops" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-green" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-green" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-prod" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-prod" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-climate" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-climate" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-esg" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-esg" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-road" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-road" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-act" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-act" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda2-journey" className="flex items-center cursor-pointer">
                  <input 
                    id="mda2-journey" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
            ...
            {/* Row 3 - Left Column */}
            <div>
              <h3 className="font-bold text-white mb-4">5. Management Discussion and Analysis</h3>
              <div className="flex flex-col gap-2 text-white text-sm">
                <label htmlFor="mda3-ffc" className="flex items-center cursor-pointer">
                  <input 
                    id="mda3-ffc" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda3-smc" className="flex items-center cursor-pointer">
                  <input 
                    id="mda3-smc" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda3-fhc" className="flex items-center cursor-pointer">
                  <input 
                    id="mda3-fhc" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda3-mic" className="flex items-center cursor-pointer">
                  <input 
                    id="mda3-mic" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda3-csrc" className="flex items-center cursor-pointer">
                  <input 
                    id="mda3-csrc" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda3-nnc" className="flex items-center cursor-pointer">
                  <input 
                    id="mda3-nnc" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda3-busrev" className="flex items-center cursor-pointer">
                  <input 
                    id="mda3-busrev" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="mda3-subs" className="flex items-center cursor-pointer">
                  <input 
                    id="mda3-subs" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
            ...
            {/* Row 3 - Right Column */}
            <div>
              <h3 className="font-bold text-white mb-4">6. Corporate Stewardship</h3>
              <div className="flex flex-col gap-2 text-white text-sm">
                <label htmlFor="cs-chair" className="flex items-center cursor-pointer">
                  <input 
                    id="cs-chair" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="cs-ids" className="flex items-center cursor-pointer">
                  <input 
                    id="cs-ids" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="cs-gov" className="flex items-center cursor-pointer">
                  <input 
                    id="cs-gov" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="cs-bod" className="flex items-center cursor-pointer">
                  <input 
                    id="cs-bod" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="cs-senior" className="flex items-center cursor-pointer">
                  <input 
                    id="cs-senior" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="cs-risk" className="flex items-center cursor-pointer">
                  <input 
                    id="cs-risk" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
            ...
            {/* Row 4 - Left Column */}
            <div>
              <h3 className="font-bold text-white mb-4">7. Financial Information</h3>
              <div className="flex flex-col gap-2 text-white text-sm">
                <label htmlFor="fin-high" className="flex items-center cursor-pointer">
                  <input 
                    id="fin-high" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="fin-cal" className="flex items-center cursor-pointer">
                  <input 
                    id="fin-cal" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="fin-audit" className="flex items-center cursor-pointer">
                  <input 
                    id="fin-audit" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="fin-inc" className="flex items-center cursor-pointer">
                  <input 
                    id="fin-inc" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="fin-spl" className="flex items-center cursor-pointer">
                  <input 
                    id="fin-spl" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="fin-pos" className="flex items-center cursor-pointer">
                  <input 
                    id="fin-pos" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="fin-eq" className="flex items-center cursor-pointer">
                  <input 
                    id="fin-eq" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="fin-cash" className="flex items-center cursor-pointer">
                  <input 
                    id="fin-cash" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="fin-notes" className="flex items-center cursor-pointer">
                  <input 
                    id="fin-notes" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
            ...
            {/* Row 4 - Right Column */}
            <div>
              <h3 className="font-bold text-white mb-4">8. Supplementary Information</h3>
              <div className="flex flex-col gap-2 text-white text-sm">
                <label htmlFor="supp-invest" className="flex items-center cursor-pointer">
                  <input 
                    id="supp-invest" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="supp-decade" className="flex items-center cursor-pointer">
                  <input 
                    id="supp-decade" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="supp-quarter" className="flex items-center cursor-pointer">
                  <input 
                    id="supp-quarter" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="supp-gov" className="flex items-center cursor-pointer">
                  <input 
                    id="supp-gov" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="supp-gri" className="flex items-center cursor-pointer">
                  <input 
                    id="supp-gri" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="supp-anti" className="flex items-center cursor-pointer">
                  <input 
                    id="supp-anti" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="supp-isa" className="flex items-center cursor-pointer">
                  <input 
                    id="supp-isa" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="supp-org" className="flex items-center cursor-pointer">
                  <input 
                    id="supp-org" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="supp-corp" className="flex items-center cursor-pointer">
                  <input 
                    id="supp-corp" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
                ...
                <label htmlFor="supp-feedback" className="flex items-center cursor-pointer">
                  <input 
                    id="supp-feedback" 
                    type="checkbox" 
                    className="mr-3 w-4 h-4 accent-[#FFC43A]" 
