...
export default function CleanEnergyPart1() {
  return (
    <div className="bg-themeGreen w-full">
      <div className="p-8">
          ...
          <CardBody className="bg-cardGreen p-4 ">
            <div className="mb-4 text-white">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Utilising energy-efficient lighting for all signage and
                  interior spaces
                </li>
                <li>
            ...
            <div className="grid grid-cols-1 mb-4 text-white">
              <div>
                ...
                <p>
                  ...
                  followed by lighting, office operations, and kitchen
                  activities. Notably, temperature and humidity levels exceeded
                  optimal ranges on weekends when the chiller system was
                  inactive. We are now implementing U Tech's recommended
                  strategies, targeting a 10% reduction in energy consumption to
                  achieve a more sustainable and energy-efficient operation.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 mb-4 text-white">
              <div>
                ...
                <p>
                  ...
                  carbon footprint, our solar powered branches programme remains
                  a key initiative in our journey towards achieving net-zero
                  carbon operations. We have invested in rooftop solar panel
                  installations across our branches, demonstrating our
                  commitment to renewable energy integration. This year, we
                  equipped 14 additional branches with solar PV systems,
                  bringing the total to 40 branches now operating with rooftop
                  solar technology.
                </p>
              </div>
            </div>
