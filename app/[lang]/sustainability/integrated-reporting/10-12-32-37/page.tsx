...
const AboutLBFinance = dynamic(() => import('@/components/content/abooutLb'), {
  ssr: false,
  suspense: true,
});

const OperatingEnvironment = dynamic(
  () => import('@/components/content/oparatingEnvironment'),
  { ssr: false, suspense: true },
);

export default function IntegratedReporting5() {
  return (
