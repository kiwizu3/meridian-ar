...
const Award: React.FC<AwardProps> = ({ title, organization, description }) => (
  <div className="mb-6">
    <h3 className="text-lg font-bold text-black">{title}</h3>
    <p className="text-sm text-black">{organization}</p>
    {description && (
      <p className="text-xs text-[#285074] mt-1">{description}</p>
    )}
  </div>
);
export default function AwardAndAccolades() {
  const loanLogo = [
    ...
    { key: '11', link: '/images/annual-report/motercycleleasing.png' },
    { key: '12', link: '/images/annual-report/mortageloan.png' }
  ];
  const depositLogo = [
  ...
  const valueAddedLogo = [
    { key: '1', link: '/images/annual-report/moneyexchange.png' },
    { key: '2', link: '/images/annual-report/LbBillPaymentsLogo.jpg' },
    { key: '3', link: '/images/annual-report/westernunion.png' },
  ];

  const fixedFdLogo = [
    { key: '1', link: '/images/annual-report/motercycleleasing.png' },
    { key: '2', link: '/images/annual-report/mortageloan.png' },
  ];
  return (
    <div className="bg-[#0A3D5F] px-4 md:pl-0 md:pr-2 custom-scrollbar h-[654px] overflow-auto grid grid-cols-1 gap-6 md:gap-8">
      <div className="mx-auto p-4 bg-gradient-to-b from-[#fc985c] via-orange-400 to-yellow-300 rounded-lg">
        <div className="flex justify-center ">
          <img
            src="/images/annual-report/Awards_group.png"
            alt="awards image"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          <div>
            <Award
              title="SPECIAL AWARD - BEST DISCLOSURE ON CAPITALS"
              organization="CMA Sri Lanka"
              description="CMA Excellence in Integrated Reporting Awards"
            />
            <Award
            ...
            />
            <Award
              title="ICSDB EXCELLENCE AWARDS"
              organization="SLIIT Business School"
              description="International Conference on Sustainable and Digital Business"
            />
          </div>

          <div>
            <Award
              title="GOLD AWARD - NON BANK FINANCIAL INSTITUTION"
              organization="CA Sri Lanka"
              description="TAGS Awards"
            />
            <Award
              title="SILVER AWARD FOR FINANCIAL SERVICES"
              organization="South Asian Best Presented Annual Report Awards (SAFA)"
            />
          </div>

          <div>
            <Award
              title="BRONZE AWARD - INTEGRATED REPORTING"
              organization="CA Sri Lanka"
              description="TAGS Awards"
            />
            <Award
              title="BRONZE - DIGITALLY TRANSFORMATIVE REPORTING"
              organization="CA Sri Lanka"
              description="TAGS Awards"
            />
            <Award
              title="10 BEST INTEGRATED REPORTS"
              organization="CMA Sri Lanka"
              description="CMA Excellence in Integrated Reporting Awards"
            />
          </div>
        ...
        <div className="grid grid-cols-1 gap-6 mb-6">
          <div className="bg-[#FFF8DC] rounded-lg p-4 h-fit">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2">
              {depositLogo?.map((item: any) => (
                <img src={item?.link} alt="loan logo" key={item} className="w-full"/>
              ))}
            </div>
          </div>
          ...
          <div className="bg-[#FFF8DC] rounded-lg p-4 h-fit">
            ...
            <div className="mt-6">
              <Product
                title="Digital Loans"
                description="Digitally granting which allows a smooth 
                            cash flow facilitating the customer to 
                            innovate and develop his business"
              />
              <Product
                title="Fixed Deposit Loans"
                description="Cost-effective option for individuals 
                            who need funds but do not want to 
                            break their FD. It allows them to meet 
                            their financial needs while still earning 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2">
                {loanLogo?.map((item: any) => (
                  <img
                    ...
                    alt="loan logo"
                    key={item}
                    className="md:h-24 md:w-full w-full"
                  />
                ))}
              </div>
            </div>
      ...
      <div className="mx-auto">
        <div className="grid grid-cols-1 gap-6 mb-6">
          <div className="bg-[#FFF8DC] rounded-lg p-4 h-fit">
            ...
            <Product
              ...
              description="Involves the buying and selling of 
            ...
            <Product
              title="Bill Payments "
              description="Customers can pay utility bills anytime 
                          with convenience, with real time 
                          payment updates."
            />
            <Product
              title="Money Remittance"
              description="Involves the transfer of funds from one 
                          individual or entity to another, often 
                          across international borders through 
                          Western Union"
            />
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2">
              {valueAddedLogo?.map((item: any) => (
                <img
                  src={item?.link}
                  alt="loan logo"
                  key={item}
        ...
        {/* <div className="relative  rounded-lg p-6">
          <img
            src="/images/annual-report/origamiHouse.png"
